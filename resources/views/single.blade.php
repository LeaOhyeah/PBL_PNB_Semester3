...
<head>
    <meta charset="utf-8">
    <title>{{ config('app.name') }}- Single News</title>
...
<body>
    ...
    <!-- Breaking News Start -->
    <div class="container-fluid mt-5 mb-3 pt-3 px-5">
        <div class="px-5">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        ...
                        {{-- <img class="img-fluid w-100" src="https://img.youtube.com/vi/k-J9BVBjK3o/sddefault.jpg" style="object-fit: cover"> --}}
                            <iframe width='1120' height='630' src='https://www.youtube.com/embed/k-J9BVBjK3o' frameborder='0' allowfullscreen style="object-fit: cover"></iframe>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="bg-white text-center border border-top-0 p-3">
                            <a href=""><img class="img-fluid" src="img/news-800x500-2.jpg"
                                    alt=""></a>
                        </div>
                    </div>
                    <!-- Ads End -->
